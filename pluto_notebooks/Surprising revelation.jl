...
# ╔═╡ 1ec6b27c-13ac-4f25-a676-e50e9db29b08
using CairoMakie

# ╔═╡ a5855385-2750-400d-9799-365b3f1c582a
using Images

# ╔═╡ 963d9935-eba6-4f99-a7de-8ce470a2cf26
using FileIO

# ╔═╡ a6d91409-5669-4364-8a66-302a5031b762
using Distances

# ╔═╡ 3a6e1d41-35d0-4c85-bb6f-1f146cc8f5c7
using Plots

# ╔═╡ 1e8fc0b7-6293-4c79-8c90-5d368f3b98c0
using GLMakie

# ╔═╡ 475d26e2-c619-4c2c-8733-941400c7b844
CairoMakie.activate!()

# ╔═╡ e8a5c1d9-1e9d-4509-ad2d-c72cdbf375fb
heatmap(fig[1,1],A,color= :grey)

# ╔═╡ 4658bb17-e242-4012-b006-9e2088331645
f = Figure()

# ╔═╡ 07cbbcf9-e204-4228-98e5-375ae7207fff
ax = Axis(f[1, 1], xlabel = "x label", ylabel = "y label",
    title = "Title")

# ╔═╡ c7191f1d-eba5-42da-8195-da5364e3aa72
f
