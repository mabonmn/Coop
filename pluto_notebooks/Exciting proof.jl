...
# ╔═╡ 0f11b1b0-602f-11ec-399e-2fd2c37038ee
begin
	using CairoMakie
	CairoMakie.activate!()

	
	x1=Matrix{Int64}(undef,100,10)
	println(x1)
	xs = range(0, 10)
	ys = range(0, 110)
...
# ╔═╡ 3fa571fc-dab0-48a9-9275-4f941f9d5e25
png_joinpathsplit__FILE__1assets241135bd50f84190a2222bcd1453a4f1png = let
    import PlutoUI
    PlutoUI.LocalResource(joinpath(split(@__FILE__, '#')[1] * ".assets", "241135bd-50f8-4190-a222-2bcd1453a4f1.png"))
end

# ╔═╡ 9a78eb46-e3a9-45d3-b02d-796fab741306
