...
# ╔═╡ 3b6b1099-4a2f-48ab-a587-b2cfe1e849be
using Pkg

# ╔═╡ ce7dbd52-a71c-411f-b6cb-de6d23640bcd
using CSV

# ╔═╡ 8280b985-1456-4938-9c7d-a4f8a87d631a
using DataFrames

# ╔═╡ 81768c87-b81f-4e9b-a896-3d9f7f8f5391
using GLMakie

# ╔═╡ 529afd4a-16f1-4ce2-a4e0-4d0030cfbf33
using Distributions

# ╔═╡ 40319cc1-70b7-4efc-acfe-01a338939ad2
using Plots

# ╔═╡ 1b8fc278-f979-4755-a5a1-eab94c57ed26
using CairoMakie

# ╔═╡ b061c509-9536-4ffd-91ca-ff0056ab283b
GLMakie.activate!()

# ╔═╡ 9e8a59a2-90aa-4bc5-a1bc-975ee6c3b870
CairoMakie.activate!()

# ╔═╡ 76209cae-0edc-4247-b4bc-dd31ff786aac
fig = Figure()

# ╔═╡ afcc9174-d94b-49f9-ab33-a4deb502f501
ax1 = Axis(fig[1:2, 1],)

# ╔═╡ a4a8e8cf-73e9-4f16-b4a8-b124a4dba6c4
...
# ╔═╡ 11c04c56-3cc5-48d8-976d-833f77eec16f
download(url,"Covid_data_1.csv")

# ╔═╡ 64fd4152-979d-4536-a2da-10fdfa347ffa
csv_data=CSV.File("Covid_data_1.csv");

# ╔═╡ fa3424db-3ffb-431d-91f3-3fe27ac6fcf0
data=DataFrame(csv_data)

# ╔═╡ 1a153959-8af2-455d-87a6-b7c8e3387131
scatter!(xs, ys, color = :red)

# ╔═╡ b968ce19-c88b-4ebb-ba59-68763606408e
fig
