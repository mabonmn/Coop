...
# ╔═╡ cbe5d6e0-61e7-11ec-3cb9-edab3e8bde3e
begin
		using Distances
		using CairoMakie
		CairoMakie.activate!()
...
# ╔═╡ 23797ba9-3073-4b0a-b1a6-a3b2b869455b
fig = Figure()

# ╔═╡ ce5feb9e-33f2-4fa7-8846-4486613dbca7
A=randn(10,100)

# ╔═╡ 547cb979-c705-4a51-b8ca-6d9bf09ccf4e
begin
		
		axes = [Axis(fig[i, j]) for i in 1:1, j in 1:2]
		tightlimits!.(axes)
		
		heatmap!([1,1],A)
		Colorbar([1,2], limits = (0, 100), colormap = :viridis,flipaxis = false)
		
		
end

# ╔═╡ 2aec76cc-c9d8-4143-97d4-ee343a539ff2
fig


# ╔═╡ 09b90454-ba97-469a-a2b5-37d43f6b7b9d
