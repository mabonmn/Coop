...
# ╔═╡ 45788d9e-614c-11ec-202d-0998f968e439
using Plots

# ╔═╡ 3b69cb1b-cdd3-42e4-995c-ddd0f6e69b24
using CairoMakie

# ╔═╡ 70b93d51-46b2-4583-b6f0-2dafd967618f
using CSV

# ╔═╡ 7aa36fc6-b333-4d81-8032-b56342d5c735
using DataFrames

# ╔═╡ 6461775f-c6b4-4929-ba44-017600a2625f
CairoMakie.activate!()

# ╔═╡ 76842320-8489-45af-a77e-2d592b931728
f = Figure()

# ╔═╡ d2a4fcc4-1a8b-4543-b97b-6ee0a7cb5cc3
Axis(f[1, 1])

# ╔═╡ 20aab8d2-24ca-4bac-b037-9601bd20771f
...
# ╔═╡ 2ee7a281-b511-4333-adb2-814bb48cadaa
download(url,"Covid_data_1.csv")

# ╔═╡ c05ffb99-8b95-4f4c-805d-ac6c310b89bf
csv_data=CSV.File("Covid_data_1.csv");

# ╔═╡ 9dac3278-a2c0-43d2-a7cf-a0aa1899e318
data=DataFrame(csv_data)

# ╔═╡ ac430c62-f1a5-4707-a84d-cee0e19dec1b
scatter!(f,1,1, color = :red)
